...
replace into `t_server_conf` (`application`, `server_name`, `node_group`, `node_name`, `registry_timestamp`,
                              ...
                              `process_id`, `patch_version`, `patch_time`, `patch_user`, `tars_version`, `posttime`,
                              `lastuser`, `server_type`, `profile`)
VALUES ('TestUnits', 'NodejsTars', '', 'localip.tars.com', now(), '', '', 'tars.nodejs.default', 0, 'active', 'active', 0,
...
VALUES ('TarsTestToolKit', 'BackendApi', 'localip.tarsadmin.com', 'TarsTestToolKit.BackendApi.apiObjAdapter', now(), 5,
        'tcp -h localip.tarsadmin.com -t 60000 -p 9001', 2000, '', 'TarsTestToolKit.BackendApi.apiObj', 10000, 60000, now(),
        'admin', 'tars', '');
replace into `t_server_conf` (`application`, `server_name`, `node_group`, `node_name`, `registry_timestamp`,
                              `base_path`, `exe_path`, `template_name`, `bak_flag`, `setting_state`, `present_state`,
                              `process_id`, `patch_version`, `patch_time`, `patch_user`, `tars_version`, `posttime`,
...
VALUES ('TarsTestToolKit', 'Frontend', 'localip.tarsadmin.com', 'TarsTestToolKit.Frontend.webObjAdapter', now(), 5,
        'tcp -h localip.tarsadmin.com -t 60000 -p 8000', 2000, '', 'TarsTestToolKit.Frontend.webObj', 10000, 60000, now(),
        'admin', 'not_tars', '');
replace into `t_server_conf` (`application`, `server_name`, `node_group`, `node_name`, `registry_timestamp`,
                              `base_path`, `exe_path`, `template_name`, `bak_flag`, `setting_state`, `present_state`,
                              `process_id`, `patch_version`, `patch_time`, `patch_user`, `tars_version`, `posttime`,
